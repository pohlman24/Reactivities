...
export default class ProfileStore {
    ...
    constructor() {
        ...
        // check if the active tab (from the profile page) is equal to the followers or following 
        reaction(
            () => this.activeTab,
            activeTab => {
    ...
    // following is what were about to change the status to
    updateFollowing = async (username: string, following: boolean) => {
        ...
        try {
            ...
            runInAction(() => {
                // if the profile page is not the currently logged in user and if the profile page is the passed in username
