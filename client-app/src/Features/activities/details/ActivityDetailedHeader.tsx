                    ...
                    <Item.Group>
                        <Item>
                            <Item.Content>
                                ...
                                <p>
                                    Hosted by <strong><Link to={`/profile/${activity.hostUsername}`}>{activity.host?.displayName}</Link></strong>
                                </p>
                            </Item.Content>
                        </Item>
                    </Item.Group>
                ...
                {activity.isHost ? (
                    <>
                        <Button 
                            ...
                            floated='left'
                            basic
                            content={activity.isCancelled ? "Re-activate Activtiy" : "Cancel Activtiy"}
